...
export const focusRiverTag = tag => exec(options.path.script + '/river-tags --focus ' + tag.toString());
export const toggleRiverTag = tag => exec(options.path.script + '/river-tags --toggle ' + tag.toString());
